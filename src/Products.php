...
//Insert Query
        ...
        $query = "INSERT INTO `products` (`title`, `details`, `picture`, `is_active`, `created_at`) VALUES (:title, :details,  :picture, :is_active, :created_at)";
...
//Insert Query
        ...
        $query = "UPDATE `products` SET `title` = :title, `details` = :details, `picture` = :picture, `is_active` = :is_active, `modified_at` = :modified_at  WHERE `products`.`id` = :id";
